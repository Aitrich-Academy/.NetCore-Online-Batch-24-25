                   ...
                   if(Count>0)
                    {
                        for (int i = 0; i < Count; i++)
                        {
                            ...
                            Console.WriteLine("Name of Admin:" + adminarray[i].Username);
                            Console.WriteLine("Name of Admin:" + adminarray[i].Email);
                            Console.WriteLine("Name of Admin:" + adminarray[i].Phonenumber);
                        }
